 ...
 * @author runmu
 */
public class WsExport implements Serializable {
	private static final long serialVersionUID = 1L;

	private String id;
	private String exportId;

	private Set<WsExportProduct> products = new HashSet<>();
	...
	public Set<WsExportProduct> getProducts() {
		return products;
	}
	public void setProducts(Set<WsExportProduct> products) {
