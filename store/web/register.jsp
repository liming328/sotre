			...
			$("#username").blur(function () {
				...
				$.ajax({
					...
					success:function (resp) {
						...
						{
						    //提示不可用
							$("#usernameMsg").css("color","red").html("已存在");
						}
						else
						{
                            //提示可用
...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form action="userServlet?method=register" method="post" class="form-horizontal" style="margin-top:5px;">
			 <div class="form-group">
			    <label for="username" class="col-sm-2 control-label">用户名</label>
			    <div class="col-sm-6">
			      <input type="text" class="form-control" name="username" id="username" placeholder="请输入用户名"> <span id="usernameMsg"></span>
			    </div>
			  </div>
			   <div class="form-group">
			 ...
			 <div class="form-group">
			  ...
			  <label for="inlineRadio1" class="col-sm-2 control-label" name="sex">性别</label>
			  <div class="col-sm-6">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-3">
			      <input type="text" name="yzm" class="form-control"  >${errorMsg}
			    </div>
			    <div class="col-sm-2">
