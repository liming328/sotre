	...
	<body>
		<div class="container-fluid">
				...
				<div class="col-md-10" id="hotProductList">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="product_info.jsp">
							<img id="fisrtHotProduct" src="" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
			...
			<script type="application/javascript">
				$.ajax({
					url:"productServlet?method=findHotProductList",
					type:"get",
                    dataType: "json",
					success:function (json) {
						//手动获取第一个商品
						var firstProduct = json[0];
						$("#fisrtHotProduct").attr("src",firstProduct.pimage);
