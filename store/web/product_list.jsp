	...
	<jsp:include page="include/header.jsp"/>
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			<ul class="pagination" style="text-align:center; margin-top:10px;">
				...
				<li class="disabled"><a href="productServlet?method=findPageByCid&cid=${param.cid}&currPage=${page.currPage-1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
				</c:if>
				<c:forEach begin="1" end="${page.totalPage}" var="currPage">
					<li  <c:if test="${page.currPage == currPage}"> class="active"</c:if> >   <a href="productServlet?method=findPageByCid&cid=${param.cid}&currPage=${currPage}">${currPage}</a></li>
				</c:forEach>
				<c:if test="${page.currPage < page.totalPage}">
				<li>
					<a href="productServlet?method=findPageByCid&cid=${param.cid}&currPage=${page.currPage+1}" aria-label="Next">
