...
<html>
	...
	<jsp:include page="include/header.jsp"/>
		...
		<div class="container">
			<div class="row">
				<c:choose>
					<c:when test="${sessionScope.cart eq null or sessionScope.cart.size()==0}">
						您还没有<a href="index.jsp">购买</a>任何商品
					</c:when>
					<c:otherwise>
							...
							<table class="table table-bordered">
								...
								<c:forEach items="${cart}" var="entry">
									...
									<tr class="active">
										...
										<td>
											<a href="cartServlet?method=deleteCartItem&pid=${entry.value.product.pid}" class="delete">删除</a>
										</td>
									</tr>
								</c:forEach>
								</tbody>
